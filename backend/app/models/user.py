...
class User(Base):
    ...
    timezone: Mapped[str] = mapped_column(String(100), nullable=False, default="Asia/Tokyo", server_default="Asia/Tokyo")
    reminder_hour: Mapped[int] = mapped_column(Integer, nullable=False, default=21, server_default="21")
